...
body_1.SetPos(chrono.ChVectorD(1.60119031478233,0.516531644005226,1.71754857525961e-16))
body_1.SetRot(chrono.ChQuaternionD(0.996814403605004,-6.66510217621709e-31,6.42865497377732e-30,-0.0797561581672549))
body_1.SetMass(4.07201324699296)
body_1.SetInertiaXX(chrono.ChVectorD(0.00988282583486595,0.222736130905484,0.230922284554103))
body_1.SetInertiaXY(chrono.ChVectorD(-0.0351935396747845,-8.43107948548348e-19,-2.59678311765443e-20))
body_1.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(1.75950018943309e-16,1.85700029468235e-17,0),chrono.ChQuaternionD(1,0,0,0)))
...
body_2.SetPos(chrono.ChVectorD(2.08512792642936,1.08951016719144,2.3184356464553e-16))
body_2.SetRot(chrono.ChQuaternionD(0.996814403604971,4.21672496261848e-16,-4.35172150274502e-16,-0.0797561581676699))
body_2.SetMass(4.07201324699296)
body_2.SetInertiaXX(chrono.ChVectorD(0.00988282583492456,0.222736130905426,0.230922284554103))
body_2.SetInertiaXY(chrono.ChVectorD(-0.0351935396749617,2.08085648996931e-16,3.55897696799726e-17))
body_2.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(1.75950018943309e-16,1.85700029468235e-17,0),chrono.ChQuaternionD(1,0,0,0)))
...
body_3.SetInertiaXX(chrono.ChVectorD(0.0042627436999619,0.00483926639146044,0.00495832194017688))
body_3.SetInertiaXY(chrono.ChVectorD(2.91911386795337e-19,2.28301849064636e-19,1.95847571862437e-19))
body_3.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(1.4075107742779e-17,0.043249333885732,-1.10809334328949e-17),chrono.ChQuaternionD(1,0,0,0)))
...
body_4.SetPos(chrono.ChVectorD(0.7,0,1.73472347597681e-17))
body_4.SetRot(chrono.ChQuaternionD(1,0,0,0))
body_4.SetMass(1.24926450899844)
body_4.SetInertiaXX(chrono.ChVectorD(0.0042627436999619,0.00483926639146044,0.00495832194017688))
body_4.SetInertiaXY(chrono.ChVectorD(2.91911386795337e-19,2.28301849064636e-19,1.95847571862437e-19))
body_4.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(1.4075107742779e-17,0.043249333885732,-1.10809334328949e-17),chrono.ChQuaternionD(1,0,0,0)))

# Visualization shape 
body_3_1_shape = chrono.ChVisualShapeModelFile() 
body_3_1_shape.SetFilename(shapes_dir +'body_3_1.obj') 
body_4.AddVisualShape(body_3_1_shape, chrono.ChFrameD(chrono.ChVectorD(0,0,0), chrono.ChQuaternionD(1,0,0,0)))
...
body_5.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(9.49452354527537e-16,-1.9383952837949e-17,-1.3100469563516e-18),chrono.ChQuaternionD(1,0,0,0)))
...
body_6.SetPos(chrono.ChVectorD(0.965480549178704,0.348079104716603,1.70290139222766e-16))
body_6.SetRot(chrono.ChQuaternionD(1.03683306464997e-18,0.93768754251937,0.347479600270268,-5.46393466527026e-19))
body_6.SetMass(3.82201324699296)
body_6.SetInertiaXX(chrono.ChVectorD(0.0826341987985947,0.110554517840008,0.191596211119023))
body_6.SetInertiaXY(chrono.ChVectorD(-0.091582091471705,1.57919984855346e-18,1.51433626835054e-18))
body_6.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(1.86621716495211e-16,2.77237112528567e-17,8.86478295616291e-19),chrono.ChQuaternionD(1,0,0,0)))
...
body_7.SetPos(chrono.ChVectorD(1.47292990417987,0.862647471026506,5.4876833193704e-17))
body_7.SetRot(chrono.ChQuaternionD(0.906986810505895,-3.21984491210804e-17,-1.10219199712073e-16,0.421159026459535))
body_7.SetMass(4.07201324699296)
body_7.SetInertiaXX(chrono.ChVectorD(0.135063421966252,0.0975555347740981,0.230922284554103))
body_7.SetInertiaXY(chrono.ChVectorD(0.110514737498251,3.28237616713828e-17,-3.85606861450939e-17))
body_7.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(1.75950018943309e-16,1.85700029468235e-17,0),chrono.ChQuaternionD(1,0,0,0)))
...
body_8.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(1.75950018943309e-16,1.85700029468235e-17,0),chrono.ChQuaternionD(1,0,0,0)))

# Visualization shape 
body_1_1_shape = chrono.ChVisualShapeModelFile() 
body_1_1_shape.SetFilename(shapes_dir +'body_1_1.obj') 
body_8.AddVisualShape(body_1_1_shape, chrono.ChFrameD(chrono.ChVectorD(0,0,0), chrono.ChQuaternionD(1,0,0,0)))
...
body_9.SetPos(chrono.ChVectorD(0.857449355002332,0.634568366309001,1.42367689219066e-16))
body_9.SetRot(chrono.ChQuaternionD(0.96370362534401,-8.49032280619758e-17,-1.33927507176121e-17,0.266974385473237))
body_9.SetMass(10.2238384765683)
body_9.SetInertiaXX(chrono.ChVectorD(0.980760799680617,2.70429795542421,3.68079882240625))
body_9.SetInertiaXY(chrono.ChVectorD(1.61647534643467,2.32693428735339e-16,-1.40723568573197e-16))
body_9.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(9.49452354527537e-16,-1.9383952837949e-17,-1.3100469563516e-18),chrono.ChQuaternionD(1,0,0,0)))

# Visualization shape 
body_5_1_shape = chrono.ChVisualShapeModelFile() 
body_5_1_shape.SetFilename(shapes_dir +'body_5_1.obj') 
body_9.AddVisualShape(body_5_1_shape, chrono.ChFrameD(chrono.ChVectorD(0,0,0), chrono.ChQuaternionD(1,0,0,0)))
...
body_10.SetPos(chrono.ChVectorD(3.34915518237306,1.74782300650624,-2.04910569993885))
body_10.SetRot(chrono.ChQuaternionD(-0.0028037641306162,0.258817954761017,-0.000751266334566173,0.965921757079174))
body_10.SetMass(4.07201324699296)
body_10.SetInertiaXX(chrono.ChVectorD(0.060897314298919,0.228398514344712,0.174245412650823))
body_10.SetInertiaXY(chrono.ChVectorD(0.00097244655418978,0.0981655675357989,-0.000569891741469255))
body_10.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(1.75950018943309e-16,1.85700029468235e-17,0),chrono.ChQuaternionD(1,0,0,0)))
...
body_11.SetPos(chrono.ChVectorD(3.72390923627308,1.75,-2.15))
body_11.SetRot(chrono.ChQuaternionD(0.965925826289068,-2.51428505198776e-16,0.258819045102521,5.74693726168631e-17))
body_11.SetMass(4.20547568872596)
body_11.SetInertiaXX(chrono.ChVectorD(0.0180439259077252,0.0415892474927246,0.0309532827377262))
body_11.SetInertiaXY(chrono.ChVectorD(8.23750473832007e-19,-0.0111798309612991,9.95089532168635e-18))
body_11.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(-1.44372465132958e-17,1.61129538715447e-18,-1.64558604272616e-17),chrono.ChQuaternionD(1,0,0,0)))
...
marker_11_1.Impose_Abs_Coord(chrono.ChCoordsysD(chrono.ChVectorD(3.72390923627308,1.75,-2.15),chrono.ChQuaternionD(0.965925826289068,-2.51428505198776E-16,0.258819045102521,5.74693726168631E-17)))
...
body_12.SetPos(chrono.ChVectorD(2.71004101034917,1.57539336922091,-1.73784798759358))
body_12.SetRot(chrono.ChQuaternionD(-0.22549962913235,0.251667293121115,-0.0604224435195309,0.939235124531335))
body_12.SetMass(4.07201324699296)
body_12.SetInertiaXX(chrono.ChVectorD(0.0954197457692436,0.193876082874387,0.174245412650824))
body_12.SetInertiaXY(chrono.ChVectorD(0.0677620548497138,0.0874668071942832,-0.0445686107643094))
body_12.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(1.75950018943309e-16,1.85700029468235e-17,0),chrono.ChQuaternionD(1,0,0,0)))
...
body_13.SetPos(chrono.ChVectorD(2.64897398514048,1.43845265975283,-1.70259092415079))
body_13.SetRot(chrono.ChQuaternionD(-0.0604224435195309,0.939235124531335,0.225499629132351,-0.251667293121115))
body_13.SetMass(10.451484)
body_13.SetInertiaXX(chrono.ChVectorD(0.0848513792626409,0.142965282790807,0.150831930135058))
body_13.SetInertiaXY(chrono.ChVectorD(0.00259666547198675,0.0466103892210022,0.00752843850527692))
body_13.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(0.0335249042145593,0.0789272030651341,2.03478998497763e-17),chrono.ChQuaternionD(1,0,0,0)))

# Visualization shape 
body_13_1_shape = chrono.ChVisualShapeModelFile() 
body_13_1_shape.SetFilename(shapes_dir +'body_13_1.obj') 
body_13.AddVisualShape(body_13_1_shape, chrono.ChFrameD(chrono.ChVectorD(0,0,0), chrono.ChQuaternionD(1,0,0,0)))

# Collision material 
mat_13 = chrono.ChMaterialSurfaceNSC()
...
pt_vect.push_back(chrono.ChVectorD(0.0499999999999999,0.24,0.06))
pt_vect.push_back(chrono.ChVectorD(0.2,0.24,0.06))
collshape = chrono.ChCollisionShapeConvexHull(mat_13,pt_vect)
body_13.GetCollisionModel().AddShape(collshape)
body_13.GetCollisionModel().Build()
...
body_14.SetPos(chrono.ChVectorD(2.45535714285633,0.579883601762942,-0.0499999999999993))
body_14.SetRot(chrono.ChQuaternionD(0.707106781186547,6.22940772466283e-16,-7.12603076539096e-16,0.707106781186548))
body_14.SetMass(14.710920688726)
body_14.SetInertiaXX(chrono.ChVectorD(1.21802361978206,0.0400589183677246,1.20291658556707))
body_14.SetInertiaXY(chrono.ChVectorD(-1.31080857132749e-16,-2.85005728778339e-17,-1.2869652456243e-16))
body_14.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(-0.00919442385254511,1.84251243587427e-18,-5.15695779302923e-18),chrono.ChQuaternionD(1,0,0,0)))
...
collshape = chrono.ChCollisionShapeBox(mat_14,0.15,0.22,0.15)
body_14.GetCollisionModel().AddShape(collshape,chrono.ChFrameD(chrono.ChVectorD(-0.5,3.78485122031303E-17,5.55111512312578E-17), mr))
body_14.GetCollisionModel().Build()
...
body_15.SetPos(chrono.ChVectorD(3.45,-1.7,-1.38777878078145e-17))
body_15.SetRot(chrono.ChQuaternionD(1,0,0,0))
body_15.SetMass(1.24926450899844)
body_15.SetInertiaXX(chrono.ChVectorD(0.0042627436999619,0.00483926639146044,0.00495832194017688))
body_15.SetInertiaXY(chrono.ChVectorD(2.91911386795337e-19,2.28301849064636e-19,1.95847571862437e-19))
body_15.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(1.4075107742779e-17,0.043249333885732,-1.10809334328949e-17),chrono.ChQuaternionD(1,0,0,0)))
body_15.SetBodyFixed(True)

# Visualization shape 
body_3_1_shape = chrono.ChVisualShapeModelFile() 
body_3_1_shape.SetFilename(shapes_dir +'body_3_1.obj') 
body_15.AddVisualShape(body_3_1_shape, chrono.ChFrameD(chrono.ChVectorD(0,0,0), chrono.ChQuaternionD(1,0,0,0)))
...
body_16.SetPos(chrono.ChVectorD(2.45009408706009,-1.56628266542599,-1.38777878078145e-17))
body_16.SetRot(chrono.ChQuaternionD(0.999976477958333,0,0,-0.00685882862065701))
body_16.SetMass(4.19339787401166)
body_16.SetInertiaXX(chrono.ChVectorD(0.0167735914960466,0.0167735914960466,0.0167735914960466))
body_16.SetInertiaXY(chrono.ChVectorD(-5.42101086242752e-20,0,0))
body_16.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(-2.29621274840129e-18,0,0),chrono.ChQuaternionD(1,0,0,0)))

# Visualization shape 
body_16_1_shape = chrono.ChVisualShapeModelFile() 
body_16_1_shape.SetFilename(shapes_dir +'body_16_1.obj') 
body_16.AddVisualShape(body_16_1_shape, chrono.ChFrameD(chrono.ChVectorD(0,0,0), chrono.ChQuaternionD(1,0,0,0)))

# Collision material 
mat_16 = chrono.ChMaterialSurfaceNSC()
...
collshape = chrono.ChCollisionShapeSphere(mat_16,0.1);
body_16.GetCollisionModel().AddShape(collshape,chrono.ChFrameD(chrono.ChVectorD(0,0,0), mr));
body_16.GetCollisionModel().Build()
...
body_17.SetPos(chrono.ChVectorD(4.20022320835452,0.95,-2.425))
body_17.SetRot(chrono.ChQuaternionD(0.5,1.54250627047993e-17,0.866025403784439,1.31816476328183e-17))
body_17.SetMass(14.7)
body_17.SetInertiaXX(chrono.ChVectorD(3.34384761479592,0.818210459183674,2.98686284438776))
body_17.SetInertiaXY(chrono.ChVectorD(-5.00979807594479e-16,0.309157879937626,-1.5513739031605e-16))
body_17.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(-6.24972484950556e-17,-4.56137867462119e-16,0.0437755102040816),chrono.ChQuaternionD(1,0,0,0)))

# Visualization shape 
body_17_1_shape = chrono.ChVisualShapeModelFile() 
...
# Collision material 
mat_17 = chrono.ChMaterialSurfaceNSC()

# Collision shapes 
body_17.GetCollisionModel().Clear()

# Triangle mesh collision shape 
body_17_1_collision_mesh = chrono.ChTriangleMeshConnected.CreateFromWavefrontFile(shapes_dir + 'body_17_1_collision.obj', False, True) 
mr = chrono.ChMatrix33D()
mr[0,0]=1; mr[1,0]=0; mr[2,0]=0 
mr[0,1]=0; mr[1,1]=1; mr[2,1]=0 
mr[0,2]=0; mr[1,2]=0; mr[2,2]=1 
body_17_1_collision_mesh.Transform(chrono.ChVectorD(0, 0, 0), mr) 
collshape = chrono.ChCollisionShapeTriangleMesh(mat_17,body_17_1_collision_mesh,False,False,sphereswept_r)
body_17.GetCollisionModel().AddShape(collshape)
body_17.GetCollisionModel().Build()
...
body_18.SetPos(chrono.ChVectorD(3.45,-1.58,-1.38777878078145e-17))
body_18.SetRot(chrono.ChQuaternionD(0.999976477958333,1.72531731076868e-43,2.34465582965004e-42,-0.00685882862065701))
body_18.SetMass(10.2238384765683)
body_18.SetInertiaXX(chrono.ChVectorD(0.0113787980347424,3.67367995707008,3.68079882240625))
body_18.SetInertiaXY(chrono.ChVectorD(-0.0502511947156836,1.081439425721e-17,2.27874263576526e-19))
body_18.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(9.49452354527537e-16,-1.9383952837949e-17,-1.3100469563516e-18),chrono.ChQuaternionD(1,0,0,0)))

# Visualization shape 
body_5_1_shape = chrono.ChVisualShapeModelFile() 
body_5_1_shape.SetFilename(shapes_dir +'body_5_1.obj') 
body_18.AddVisualShape(body_5_1_shape, chrono.ChFrameD(chrono.ChVectorD(0,0,0), chrono.ChQuaternionD(1,0,0,0)))
...
body_19.SetPos(chrono.ChVectorD(4.4499059129399,-1.59371733457401,-2.77555756156289e-17))
body_19.SetRot(chrono.ChQuaternionD(1,0,0,0))
body_19.SetMass(4.19339787401166)
body_19.SetInertiaXX(chrono.ChVectorD(0.0167735914960466,0.0167735914960466,0.0167735914960466))
body_19.SetInertiaXY(chrono.ChVectorD(0,0,0))
body_19.SetFrame_COG_to_REF(chrono.ChFrameD(chrono.ChVectorD(-2.29621274840129e-18,0,0),chrono.ChQuaternionD(1,0,0,0)))

# Visualization shape 
body_16_1_shape = chrono.ChVisualShapeModelFile() 
body_16_1_shape.SetFilename(shapes_dir +'body_16_1.obj') 
body_19.AddVisualShape(body_16_1_shape, chrono.ChFrameD(chrono.ChVectorD(0,0,0), chrono.ChQuaternionD(1,0,0,0)))
...
mr[0,1]=0; mr[1,1]=1; mr[2,1]=0 
mr[0,2]=0; mr[1,2]=0; mr[2,2]=1 
collshape = chrono.ChCollisionShapeSphere(mat_19,0.1);
body_19.GetCollisionModel().AddShape(collshape,chrono.ChFrameD(chrono.ChVectorD(0,0,0), mr));
body_19.GetCollisionModel().Build()
...
dA = chrono.ChVectorD(0,0,1)
dB = chrono.ChVectorD(2.43731035938427e-18,-6.2718405890427e-19,1)
link_3.Initialize(body_3,body_5,False,cA,cB,dB)
...
cB = chrono.ChVectorD(0.985709765604091,0.28845253928853,1.92139317440777e-16)
dB = chrono.ChVectorD(2.43731035938427e-18,-6.2718405890427e-19,1)
link_4.Initialize(body_3,body_5,False,cA,cB,dA,dB)
...
link_5.Initialize(body_3,body_9,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(0,0,1)
dB = chrono.ChVectorD(-7.11472591128629e-17,1.56492054588209e-16,1)
link_6.Initialize(body_3,body_9,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(0,0,1)
dB = chrono.ChVectorD(7.11472591128629e-17,-1.56492054588209e-16,-1)
link_7.Initialize(body_3,body_9,False,cA,cB,dB)
...
link_8.Initialize(body_3,body_9,False,cA,cB,dA,dB)
...
link_9.Initialize(body_3,body_4,False,cA,cB,dB)
...
dA = chrono.ChVectorD(0,0,1)
dB = chrono.ChVectorD(0,-1,0)
link_11.Initialize(body_4,body_3,False,cB,cA,dA)
...
cB = chrono.ChVectorD(0.6,0.02,0.075)
dB = chrono.ChVectorD(0,-1,0)
link_12.Initialize(body_4,body_3,False,cB,cA,dB,dA)
...
link_13.Initialize(body_7,body_2,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(-2.27056055777414e-16,-3.44324843526416e-17,1)
dB = chrono.ChVectorD(-9.34833691496372e-16,-7.71243118060831e-16,1)
link_14.Initialize(body_7,body_2,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(-2.27056055777414e-16,-3.44324843526416e-17,1)
dB = chrono.ChVectorD(-9.34833691496372e-16,-7.71243118060831e-16,1)
link_15.Initialize(body_7,body_2,False,cA,cB,dB)
...
cB = chrono.ChVectorD(1.71489871000361,1.14913673261973,0.0249999999999999)
dB = chrono.ChVectorD(-9.34833691496372e-16,-7.71243118060831e-16,1)
link_16.Initialize(body_7,body_2,False,cA,cB,dA,dB)
...
link_19.Initialize(body_8,body_1,False,cA,cB)
...
link_20.Initialize(body_8,body_1,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(-2.27056055777414e-16,-3.44324843526416e-17,1)
dB = chrono.VNULL
link_21.Initialize(body_1,body_7,False,cB,cA,dB,dA)
...
dB = chrono.ChVectorD(-9.34833691496372e-16,-7.71243118060831e-16,1)
link_22.Initialize(body_9,body_2,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(-7.11472591128629e-17,1.56492054588209e-16,1)
dB = chrono.ChVectorD(-9.34833691496372e-16,-7.71243118060831e-16,1)
link_23.Initialize(body_9,body_2,False,cA,cB,dA,dB)
...
link_24.Initialize(body_7,body_9,False,cB,cA,dA)
...
cB = chrono.ChVectorD(1.67670014179118,1.1813992400629,0.0250000000000001)
dB = chrono.ChVectorD(-0.645250148863313,-0.763971364248604,-1.72813385836049e-16)
link_25.Initialize(body_7,body_9,False,cB,cA,dB,dA)
...
link_28.Initialize(body_6,body_4,False,cA,cB,dA,dB)
...
link_29.Initialize(body_6,body_4,False,cA,cB,dB)
...
link_30.Initialize(body_6,body_1,False,cA,cB,dA,dB)
...
link_32.Initialize(body_8,body_14,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(3.29586719110857e-16,2.6955935802425e-17,1)
dB = chrono.ChVectorD(-1.26801646453392e-16,-1.88874422440737e-15,1)
link_33.Initialize(body_8,body_14,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(-9.34833691496372e-16,-7.71243118060831e-16,1)
dB = chrono.ChVectorD(-1.26801646453392e-16,-1.88874422440737e-15,1)
link_34.Initialize(body_2,body_14,False,cA,cB,dB)
...
cB = chrono.ChVectorD(2.40535714285633,0.0798836017629421,0.0249999999999997)
dB = chrono.ChVectorD(-1.26801646453392e-16,-1.88874422440737e-15,1)
link_35.Initialize(body_2,body_14,False,cA,cB,dA,dB)
...
dB = chrono.ChVectorD(0,0,1)
link_36.Initialize(body_18,body_15,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(4.68683462596568e-42,-3.7721853057659e-43,1)
dB = chrono.ChVectorD(0,0,1)
link_37.Initialize(body_18,body_15,False,cA,cB,dA,dB)
...
dB = chrono.ChVectorD(0,0,-1)
link_38.Initialize(body_18,body_15,False,cA,cB,dB)
...
cB = chrono.ChVectorD(3.45,-1.58,0.025)
dB = chrono.ChVectorD(0,0,-1)
link_39.Initialize(body_18,body_15,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(0,0,1)
dB = chrono.ChVectorD(0,0,1)
link_40.Initialize(body_4,body_15,False,cA,cB,dB)
...
cB = chrono.ChVectorD(3.35,-1.68,0.075)
dB = chrono.ChVectorD(0,0,1)
link_41.Initialize(body_4,body_15,False,cA,cB,dA,dB)
...
link_42.Initialize(body_4,body_3,False,cA,cB,dB)
...
cB = chrono.ChVectorD(0,0,0)
dB = chrono.ChVectorD(1,0,0)
link_43.Initialize(body_4,body_3,False,cA,cB,dA,dB)
...
dB = chrono.ChVectorD(0,1,0)
link_44.Initialize(body_17,body_0,False,cA,cB,dB)
...
link_45.Initialize(body_17,body_0,False,cA,cB,dA,dB)
...
link_46.Initialize(body_17,body_0,False,cA,cB,dB)
...
link_47.Initialize(body_17,body_0,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(-9.34833691496372e-16,-7.71243118060831e-16,1)
dB = chrono.ChVectorD(3.29586719110857e-16,2.6955935802425e-17,1)
link_48.Initialize(body_2,body_8,False,cA,cB,dB)
...
cB = chrono.ChVectorD(2.21338833703225,0.743394340170001,8.42825665436867e-17)
dB = chrono.ChVectorD(3.29586719110857e-16,2.6955935802425e-17,1)
link_49.Initialize(body_2,body_8,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(4.68683462596568e-42,-3.7721853057659e-43,1)
dB = chrono.ChVectorD(0,0,1)
link_50.Initialize(body_18,body_16,False,cA,cB,dB)
...
cB = chrono.ChVectorD(2.45009408706009,-1.56628266542599,-1.38777878078145e-17)
dB = chrono.ChVectorD(0,0,1)
link_51.Initialize(body_18,body_16,False,cA,cB,dA,dB)
...
link_52.Initialize(body_18,body_16,False,cA,cB,dB)
...
cB = chrono.ChVectorD(2.45009408706009,-1.56628266542599,-1.38777878078145e-17)
dB = chrono.ChVectorD(0.0137173345740088,0.999905912939905,0)
link_53.Initialize(body_18,body_16,False,cA,cB,dA,dB)
...
link_54.Initialize(body_16,body_18,False,cA,cB,dB)
...
cB = chrono.ChVectorD(3.45,-1.58,-1.38777878078145e-17)
dB = chrono.ChVectorD(0.999905912939905,-0.0137173345740088,-4.69156808826601e-42)
link_55.Initialize(body_16,body_18,False,cA,cB,dA,dB)
...
dB = chrono.ChVectorD(1,0,0)
link_56.Initialize(body_14,body_0,False,cA,cB,dB)
...
link_57.Initialize(body_14,body_0,False,cA,cB,dA,dB)
...
link_58.Initialize(body_18,body_19,False,cA,cB)
...
dB = chrono.ChVectorD(0.500000000000001,0,0.866025403784438)
link_59.Initialize(body_11,body_0,False,cA,cB,dB)
...
cB = chrono.ChVectorD(0,0,0)
dB = chrono.ChVectorD(0.500000000000001,0,0.866025403784438)
link_60.Initialize(body_11,body_0,False,cA,cB,dA,dB)
...
dB = chrono.ChVectorD(0,1,0)
link_61.Initialize(body_11,body_0,False,cA,cB,dB)
...
cB = chrono.ChVectorD(0,0,0)
dB = chrono.ChVectorD(0,1,0)
link_62.Initialize(body_11,body_0,False,cA,cB,dA,dB)
...
link_63.Initialize(body_11,body_17,False,cA,cB,dB)
...
link_64.Initialize(body_11,body_17,False,cA,cB,dA,dB)
...
link_65.Initialize(body_10,body_12,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(0.500000000000002,-4.05816873161324e-16,0.866025403784438)
dB = chrono.ChVectorD(0.499999999999998,-1.79869140415345e-16,0.86602540378444)
link_66.Initialize(body_10,body_12,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(-0.500000000000002,4.05816873161324e-16,-0.866025403784438)
dB = chrono.ChVectorD(0.499999999999998,-1.79869140415345e-16,0.86602540378444)
link_67.Initialize(body_10,body_12,False,cA,cB,dB)
...
link_68.Initialize(body_10,body_12,False,cA,cB,dA,dB)
...
link_69.Initialize(body_13,body_12,False,cA,cB,dB)
...
link_70.Initialize(body_13,body_12,False,cA,cB,dA,dB)
...
dB = chrono.ChVectorD(0.499999999999998,-1.79869140415345e-16,0.86602540378444)
link_71.Initialize(body_13,body_12,False,cA,cB,dB)
...
link_72.Initialize(body_13,body_12,False,cA,cB,dA,dB)
...
link_73.Initialize(body_12,body_13,False,cA,cB,dB)
...
link_74.Initialize(body_12,body_13,False,cA,cB,dA,dB)
...
link_75.Initialize(body_10,body_11,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(0.500000000000002,-4.05816873161324e-16,0.866025403784438)
dB = chrono.ChVectorD(0.500000000000001,5.82867087928207e-16,0.866025403784438)
link_76.Initialize(body_10,body_11,False,cA,cB,dA,dB)
...
dA = chrono.ChVectorD(0.500000000000002,-4.05816873161324e-16,0.866025403784438)
dB = chrono.ChVectorD(-0.500000000000001,-5.82867087928207e-16,-0.866025403784438)
link_77.Initialize(body_10,body_11,False,cA,cB,dB)
...
link_78.Initialize(body_10,body_11,False,cA,cB,dA,dB)
